...
namespace expression_members
{
    ...
    class Program
    {
        ...
        {
           List<string> preds = new List<string> {"cats", "dogs", "parrots"}; 
           List<string> preys = new List<string> {"crumbs", "chips", "crackers"}; 
           Bug ant = new Bug(name:"ant", species:"critter",  predators:preds, prey:preys); 
        }
    }
}